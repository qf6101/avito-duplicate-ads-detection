...
function work(){
 ...
 | python -m feature.image_mxnet_feature $*
}

# Generate image feature for training data set and testing data set
cat data/data_files/image_itemPairs_train.csv | work --model bn $* > data/data_files/image_mxnet_feature_train_bn.csv
cat data/data_files/image_itemPairs_test.csv | work --model bn $* > data/data_files/image_mxnet_feature_test_bn.csv
